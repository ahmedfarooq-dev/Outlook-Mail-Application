...
Route::get('/outlook/email/{id}', 'OutlookController@showEmail')->name('outlook.email.show');
Route::get('/outlook/email/{emailId}/attachment/{attachmentId}', 'OutlookController@downloadAttachment')
